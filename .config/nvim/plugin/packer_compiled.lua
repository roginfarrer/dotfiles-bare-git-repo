...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-ts-context-commentstring', 'package-info.nvim', 'nvim-treesitter', 'vim-markdown', 'vim-mdx-js', 'nvim-colorizer.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
