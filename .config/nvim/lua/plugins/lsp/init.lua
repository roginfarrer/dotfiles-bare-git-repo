...
local on_attach = function(client, bufnr)
	...
	u.buf_map("n", "<C-F>", "<cmd> lua require('lspsaga.action').smart_scroll_with_saga(1)<CR>", nil, bufnr)
	u.buf_map("n", "<C-B>", "<cmd> lua require('lspsaga.action').smart_scroll_with_saga(-1)<CR>", nil, bufnr)
	u.buf_map("n", "<leader>do", ":Lspsaga code_action<CR>", nil, bufnr)
	u.buf_map("v", "<leader>do", ":<C-U>Lspsaga range_code_action<CR>", nil, bufnr)

	-- u.buf_map("n", "gd", ":LspPeekDef<CR>", nil, bufnr)
	-- u.buf_map("n", "gt", ":LspTypeDef<CR>", nil, bufnr)
	-- u.buf_map("n", "<leader>lr", ":LspRename<CR>", nil, bufnr)
	-- u.buf_map("n", "K", ":LspHover<CR>", nil, bufnr)
	-- u.buf_map("n", "[g", ":LspDiagPrev<CR>", nil, bufnr)
	-- u.buf_map("n", "]g", ":LspDiagNext<CR>", nil, bufnr)
