...
const provider_1 = __webpack_require__(32);
const snipmateProvider_1 = __webpack_require__(36);
const textmateProvider_1 = __webpack_require__(40);
const ultisnipsProvider_1 = __webpack_require__(46);
const util_2 = __webpack_require__(34);
const languages_1 = __importDefault(__webpack_require__(49));
...
async function activate(context) {
    ...
    subscriptions.push(coc_nvim_1.languages.registerCompletionItemProvider('snippets-source', 'S', ['snippets'], languageProvider, ['$']));
...
Author Qiming Zhao <chemzqm@gmail> (https://github.com/chemzqm)
*******************************************************************/
const pify_1 = __importDefault(__webpack_require__(35));
const fs_1 = __importDefault(__webpack_require__(3));
...
const fs_1 = __importDefault(__webpack_require__(3));
const path_1 = __importDefault(__webpack_require__(4));
const readline_1 = __importDefault(__webpack_require__(37));
const vscode_languageserver_types_1 = __webpack_require__(6);
const baseProvider_1 = __importDefault(__webpack_require__(38));
const types_1 = __webpack_require__(33);
const util_1 = __webpack_require__(34);
const parser_1 = __importDefault(__webpack_require__(39));
...
const coc_nvim_1 = __webpack_require__(1);
const fs_1 = __importDefault(__webpack_require__(3));
const jsonc_parser_1 = __webpack_require__(41);
const os_1 = __importDefault(__webpack_require__(2));
const path_1 = __importDefault(__webpack_require__(4));
const util_1 = __importDefault(__webpack_require__(5));
const vscode_languageserver_types_1 = __webpack_require__(6);
...
/* harmony import */ var _impl_format__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(42);
/* harmony import */ var _impl_edit__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(44);
/* harmony import */ var _impl_scanner__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(43);
/* harmony import */ var _impl_parser__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(45);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* harmony import */ var _scanner__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(43);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* harmony import */ var _format__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(42);
/* harmony import */ var _parser__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(45);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
const baseProvider_1 = __importDefault(__webpack_require__(38));
const types_1 = __webpack_require__(33);
const ultisnipsParser_1 = __importDefault(__webpack_require__(47));
const util_1 = __webpack_require__(34);
class UltiSnippetsProvider extends baseProvider_1.default {
    ...
    async init() {
        ...
        let pythonCode = await util_1.readFileAsync(path_1.default.join(__dirname, '../python/ultisnips.py'), 'utf8');
        ...
        if (pythonCode) {
            let { nvim } = coc_nvim_1.workspace;
            let hash = crypto_1.default.createHash('md5').update(pythonCode).digest('hex');
            let tmpfile = path_1.default.join(os_1.default.tmpdir(), `coc-ultisnips-${hash}.py`);
            if (!fs_1.default.existsSync(tmpfile)) {
                fs_1.default.writeFileSync(tmpfile, pythonCode, 'utf8');
            }
