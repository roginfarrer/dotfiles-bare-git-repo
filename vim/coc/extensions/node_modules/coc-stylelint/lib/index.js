...
function activate(context) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const config = coc_nvim_1.workspace.getConfiguration().get('stylelint', {});
        if (!config.enable)
            return;
        ...
        let client = new coc_nvim_1.LanguageClient('stylelint', 'stylelint langserver', serverOptions, clientOptions);
