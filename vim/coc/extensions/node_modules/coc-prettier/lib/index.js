...
const PrettierEditProvider_1 = tslib_1.__importStar(__webpack_require__(41));
...
function activate(context) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        context.subscriptions.push(coc_nvim_1.commands.registerCommand('prettier.formatFile', () => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (onlyUseLocalVersion && (!utils_1.hasLocalPrettierInstalled(coc_nvim_1.Uri.parse(document.uri).fsPath) || document.schema != 'file')) {
...
const errorHandler_1 = __webpack_require__(33);
const utils_1 = __webpack_require__(36);
const ignore = __webpack_require__(40);
...
const coc_nvim_1 = __webpack_require__(2);
const path_1 = __webpack_require__(13);
const requirePkg_1 = __webpack_require__(37);
...
const tslib_1 = __webpack_require__(1);
const errorHandler_1 = __webpack_require__(33);
const resolve_from_1 = tslib_1.__importDefault(__webpack_require__(38));
...
function requireLocalPkg(fspath, pkgName, options = { silent: true, ignoreBundled: false }) {
    ...
    if (modulePath !== void 0) {
        try {
            ...
            if (!options.silent) {
                errorHandler_1.addToOutput(`Failed to load ${pkgName} from ${modulePath}.${options.ignoreBundled ? `` : ` Using bundled`}`, 'Error');
            }
        }
    }
...
const Module = __webpack_require__(39);
    ...
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (!prettierInstance && !options.onlyUseLocalVersion) {
                prettierInstance = __webpack_require__(32);
            }
...
function format(text, { languageId, uri }, customOptions) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        if (!dynamicParsers.length) {
            const bundledParsers = utils_1.getParsersFromLanguageId(languageId, __webpack_require__(32), isUntitled ? undefined : fileName);
        ...
        if (!doesParserSupportEslint && useBundled) {
            let bundledPrettier = __webpack_require__(32);
            return errorHandler_1.safeExecution(() => {
